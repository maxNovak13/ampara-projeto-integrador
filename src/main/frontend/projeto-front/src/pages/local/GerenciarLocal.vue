<<template>
  <div class="p-6 max-w-5xl mx-auto">
    ...
    <div class="w-full max-w-4xl mx-auto">
      ...
      <div v-if="locais.length === 0 && !erro" class="text-center text-gray-600 py-10">
    ...
    <!-- Mensagem de erro -->
    <div v-if="erro" class="text-red-500 text-center mt-4">
      {{ erro }}
    </div>
...
<script setup>
  ...
  onMounted(async () => {
    ...
    try {
      const response = await api.get('/local/listar')
